...
public class MainEngineerActivity extends AppCompatActivity {
    ...
    private LinearLayout rateLNRLYT;
    ...
    private void getView() {
        ...
        addLNRLYT = (LinearLayout)findViewById(R.id.addLNRLYT);
        ...
        rateLNRLYT = (LinearLayout)findViewById(R.id.rateLNRLYT);

        rateLNRLYT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                i.putExtra("intent_activity", "WorkersRateActivity");
                startActivity(i);
            }
        });
        ...
        addLNRLYT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        logOutMGVW.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MainEngineerActivity.this);
